# ttyd-mod
This repository is used to customize and build [ttyd](https://github.com/tsl0922/ttyd), a command-line tool for sharing terminal over the web.

## Customization
- An SVG favicon adaptive to light/dark mode
